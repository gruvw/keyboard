...
1. Follow the QMK setup instructions: <https://docs.qmk.fm/newbs_getting_started> (`qmk` CLI)
...
4. Clone this repository to `qmk_firmware/keyboards/beekeeb`: `git clone --single-branch https://github.com/gruvw/keyboard.git .`
